...
if __name__ == '__main__':
    ...
    logging.info('Starting scoring API (dev) - ML-ENHANCED VERSION')
    logging.info('ML Features: %s', 'ENABLED' if ML_AVAILABLE else 'DISABLED (install dependencies)')
    ...
    logging.info("  ML endpoint: http://<YOUR_COMPUTER_LAN_IP>:%d/ml-score", port)
